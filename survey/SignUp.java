		...
		submit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(fname.isEmpty() || uname.isEmpty() || pass1.isEmpty() || pass2.isEmpty()) {
					JOptionPane.showMessageDialog(frame, "Enter username and password both", "Caution", JOptionPane.WARNING_MESSAGE);
				}
				else {
					if(pass1.equals(pass2)) {
						try {
							...
							JOptionPane.showMessageDialog(frame, "Something went wrong", "Caution", JOptionPane.WARNING_MESSAGE);
						}
						
					}
					else {
						JOptionPane.showMessageDialog(frame, "Password Mismatch", "Caution", JOptionPane.WARNING_MESSAGE);
					}
				}
			}
		});
